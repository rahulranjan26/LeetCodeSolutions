...
</span><br><br><span style="font-size: 18px;"><strong>Input: </strong>arr[][] = [[0, 0], [1, 1]]
...
<p><br><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ number of rows,&nbsp;</span><span style="font-size: 18px;">number of columns</span><span style="font-size: 18px;">&nbsp;≤ 10</span><sup>3</sup></p>
<p><span style="font-size: 18px;">0 ≤ arr[i][j] ≤ 1&nbsp;</span></p>
